...
The main outcome variable of interest is the cumulative work (`cumulative_work`) produced during the social support and control condition rowing trials. Cumulative work will be a single number, expressed as the total Wattage (W) produced during the trial, which will be calculated by adding up the W of every stroke completed during the trial.
